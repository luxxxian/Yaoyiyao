package com.example.fds75.yaoyiyao;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume(){
        ...
        if (sensorManager != null){//注册监听器
            ...
            //第一个参数是Listener，第二个参数是所获得传感器类型，第三个参数值获得传感器信息的频率
        }
    }
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg){
            ...
            switch (msg.what){
                case 10:
                    //Toast.makeText(ShackActicity.this,"检测到摇晃，执行操作！",Toast.LENGTH_SHORT).show();
                    Log.i(TAG, "检测到摇晃，执行操作！");
                    java.util.Random r = new java.util.Random();//构造随机数
